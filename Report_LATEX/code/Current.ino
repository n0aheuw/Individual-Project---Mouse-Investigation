...
void loop() {
  ...
  // reads the voltage level over Shunt_Ref_1 and Shunt_Ref_2
  // and stores as a value 0->1023 representing 0->3.3V.
  readings = int(voltage_diff(analogRead(A0),analogRead(A1))); 
...
//function to calulate the difference in voltage observed from two points
int voltage_diff(int v1, int v2)
{
